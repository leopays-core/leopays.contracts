...
namespace eosiosystem {
   ...
   // - `payment` LPC tokens paid for the loan,
   // - `balance` is the amount of LPC tokens available to be used for loan auto-renewal,
   ...
   class [[eosio::contract("eosio.system")]] system_contract : public native {
      ...
      public:
         ...
         /**
          * Delegate bandwidth and/or cpu action. Stakes LPC from the balance of `from` for the benefit of `receiver`.
          *
         ...
         /**
          * Rentcpu action, uses payment to rent as many LPC tokens as possible as determined by market price and
         ...
         /**
          * Rentnet action, uses payment to rent as many LPC tokens as possible as determined by market price and
          ...
          * @pre Voter must have previously staked some LPC for voting
