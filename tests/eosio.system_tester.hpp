...
public:
   ...
   void create_core_token( symbol core_symbol = symbol{CORE_SYM} ) {
      ...
      create_currency( N(lpc.token), config::system_account_name, asset(10000000000000, core_symbol) );
      issue( asset(1000000000000, core_symbol) );
      BOOST_REQUIRE_EQUAL( asset(1000000000000, core_symbol), get_balance( "lpc", core_symbol ) );
   }
